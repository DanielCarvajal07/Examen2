<%@ Page Title="" Language="C#" MasterPageFile="~/menu.Master" AutoEventWireup="true" CodeBehind="Tecnicos.aspx.cs" Inherits="ExamenUH.Tecnicos" %>
...
<div class="contanie text-center">   
    ...
    <div class="container text-center">
        TecnicoID: <asp:TextBox ID="ttecnico" class="form-control" runat="server"></asp:TextBox>
